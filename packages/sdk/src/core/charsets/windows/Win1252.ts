/**
 * @fileoverview Windows 1252 (Western European) Character Set
 * Most common Windows character set for Western Europe
 */
 ...
 * The default character set for Windows in Western European locales
 * Very similar to ISO 8859-1 but with additional printable characters in the 128-159 range
 */
export class Win1252CharacterSet extends SingleByteCharacterSet {
  readonly ciValue = ZPLCharacterSet.WIN_1252;
  readonly name = 'Windows 1252';
  readonly description = 'Windows Western European - Most common modern Windows charset';
  ...
  private createMappings(): {
    ...
    const byteToUnicode: Record<number, string> = {
      ...
      // Windows 1252 specific (128-159) - Key difference from ISO 8859-1
      // Note: positions 129, 141, 143, 144, 157 are UNDEFINED (0x81, 0x8D, 0x8F, 0x90, 0x9D)
      128: '€', 129: '', 130: '‚', 131: 'ƒ', 132: '„', 133: '…', 134: '†', 135: '‡',
      136: 'ˆ', 137: '‰', 138: 'Š', 139: '‹', 140: 'Œ', 141: '', 142: 'Ž', 143: '',
      144: '', 145: '\u2018', 146: '\u2019', 147: '\u201C', 148: '\u201D', 149: '•', 150: '–', 151: '—',
      152: '˜', 153: '™', 154: 'š', 155: '›', 156: 'œ', 157: '', 158: 'ž', 159: 'Ÿ',

      // ISO 8859-1 compatible (160-255)
